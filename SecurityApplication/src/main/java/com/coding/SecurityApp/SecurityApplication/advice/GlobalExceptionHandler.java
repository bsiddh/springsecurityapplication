...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAccessDeniedException(AccessDeniedException ad){
        ApiError apiError = new ApiError(ad.getLocalizedMessage(),HttpStatus.FORBIDDEN);
